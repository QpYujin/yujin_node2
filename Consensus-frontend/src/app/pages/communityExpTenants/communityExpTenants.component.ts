...
@Component({
  selector: 'communityExpTenants',
  templateUrl: './communityExpTenants.html',
  styleUrls: ['./communityExpTenants.scss']
})
...
export class CommunityExpTenants {
  ...
  private authService: AuthService) {
    ...
    this.communityService.getCommunitiesExpenses().then(data => {
      ...
      if(this.communityExpenses !=null || this.communityExpenses !=[]){
        this.setBoolean=true;
      }
      else{
        this.setBoolean=true;
